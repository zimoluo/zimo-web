...
export default function ToastCard({
  ...
  return (
    <div
      className={`rounded-full md:rounded-2xl bg-widget-100 md:bg-widget-80 backdrop-blur-lg flex border-opacity-75 border-0.8 border-saturated text-sm md:text-base ${toastStyle.sizing} px-2 py-1 md:py-1.5 md:shadow ${className}`}
    >
