  ...
  return (
    <div className="relative flex items-center">
      <input
        ...
        className="w-full py-2 pl-3 pr-10 border rounded-full overflow-hidden bg-transparent bg-widget-70 backdrop-blur-lg border-soft border-opacity-75 border-menu-entry shadow-lg placeholder:text-saturated placeholder:text-opacity-70"
      />
