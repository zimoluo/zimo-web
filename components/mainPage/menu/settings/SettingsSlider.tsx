...
export default function SettingsSlider({
  ...
  return (
    ...
    >
      <div className="absolute w-9/10 h-2 border-soft bg-pastel border-opacity-80 border-0.8 bg-opacity-30 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2">
        ...
        >
          <div
            className={`border-soft border-0.6 shadow-md w-2.5 h-6 rounded-full transition-all ease-in-out -translate-x-1 -translate-y-2.25 ${
              isDragging
