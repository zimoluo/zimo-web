...
export default function NotebookLayout({ children }: Props) {
  return (
    <div className="w-screen h-screen min-h-[25rem] flex justify-center">
      <div
        className={`${notebookPageStyle.container} mt-[68px] sm:mt-[72px] shadow-xl rounded-b-[2rem] md:rounded-[2rem] backdrop-blur-reading overflow-hidden md:outline md:outline-1 md:outline-highlight-light/15`}
      >
        <WindowNotebook />
      </div>
    </div>
