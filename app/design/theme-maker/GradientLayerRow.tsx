...
export default function GradientLayerRow({ gradientData, index }: Props) {
  ...
  return (
    <div
      className={`rounded-lg bg-pastel bg-opacity-80 shadow-sm w-full h-12 flex items-center p-2 gap-2 relative ${selectorStyle.rowContainer}`}
    >
      <button
      ...
      >
        <div
          className={`absolute w-full h-full left-0 top-0 rounded-lg border-2 border-soft border-opacity-75 ${
