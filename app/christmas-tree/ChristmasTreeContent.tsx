...
export default async function ChristmasTreeContent() {
  ...
  return (
    <ChristmasTreeSelectorProvider initialTree={treeContent}>
      <ChristmasTreePlacer />
      <div className="w-full md:w-min md:max-w-full h-full flex flex-col md:flex-row gap-1 md:gap-0 bg-widget-70 md:rounded-[2rem] md:shadow-xl backdrop-blur-reading pb-8 md:p-0 md:outline md:outline-1 md:outline-highlight-light/15">
        <div
