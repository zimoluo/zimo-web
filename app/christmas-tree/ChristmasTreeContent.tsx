...
export default async function ChristmasTreeContent() {
  ...
  return (
    <ChristmasTreeSelectorProvider initialTree={treeContent}>
      <ChristmasTreePlacer />
      <div className="w-full md:w-min md:max-w-full h-full flex flex-col md:flex-row gap-1 md:gap-0 bg-widget-50 md:rounded-[2rem] md:shadow-xl backdrop-blur-2xl pb-8 md:p-0">
        <div
