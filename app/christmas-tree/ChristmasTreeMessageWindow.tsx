    ...
    <div className="rounded-[2rem] w-full h-full bg-widget-90 shadow-xl relative overflow-hidden">
      ...
      <div className="w-full h-full relative p-3 flex flex-col">
        ...
        <div className="w-full flex justify-end">
          <button
            className={`rounded-full font-fancy ${windowStyle.buttonBg} border-reflect-light transition-colors duration-300 ease-out text-center h-10 text-lg shadow-lg px-4`}
            onClick={closePopUp}
          >
            Happy Holidays!
          </button>
